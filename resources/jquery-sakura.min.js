!function (n) {
    !function () {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function (i) {
            var a = (new Date).getTime(), t = Math.max(0, 16 - (a - n)), o = window.setTimeout(function () {
                i(a + t)
            }, t);
            return n = a + t, o
        ...
        var o = ["moz", "ms", "o", "webkit", ""], e = o.length, m = {
        ...
        }, i = n.extend({}, m, i), r = n(document).height(), s = n(document).width(), w = n('<div class="' + i.className + '" />');
        n("body").css({"overflow-x": "hidden"});
        var d = function () {
            setTimeout(function () {
                requestAnimationFrame(d)
            }, i.newOn);
            var o = i.blowAnimations[Math.floor(Math.random() * i.blowAnimations.length)], e = i.swayAnimations[Math.floor(Math.random() * i.swayAnimations.length)],
                ...
                u = w.clone(), c = a(i.minSize, i.maxSize), h = Math.random() * s - 100, f = -(20 * Math.random() + 15);
